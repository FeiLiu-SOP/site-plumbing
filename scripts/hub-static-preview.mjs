 ...
 * Astro `preview` + base + nest move can 404 on `/plumbing/`; this serves `dist/` verbatim.
 *
 * Usage: node ./scripts/hub-static-preview.mjs [segment] [--port 4321]
 * Default segment: plumbing (matches nest-hub-segment.mjs default for this site).
 */
