...
Risk flag: Seasonal Arnold, MD irrigation cross-connections can mask domestic pressure loss.

Step: pressure-hold domestic lines before declaring leak isolation complete.

Material note: Water heater anode type may change with Arnold, MD hardness profiles.

Step: verify expansion tank pre-charge when heaters are replaced.

Stack vent offsets in Arnold, MD older duplexes can mask tub gurgle as a main-line failure.

Basement floor drains in Arnold, MD should be snaked only after trap arm geometry is confirmed on camera.
