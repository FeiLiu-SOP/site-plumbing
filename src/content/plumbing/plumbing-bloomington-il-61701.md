...
Risk flag: Seasonal Bloomington, IL irrigation cross-connections can mask domestic pressure loss.

Step: verify expansion tank pre-charge when heaters are replaced.

Material note: No-hub cast iron couplings require torque verification after settlement events.

Book sump and supply-line checks in one written scope. Serving ZIP Code: 61701.
...
Frost-free sillcock failures in Bloomington, IL often trace to interior shutoff seats, not exterior stems.

Risk flag: Jetting without camera proof can damage fragile clay joints.

Code note: T&P discharge must not terminate where scalding risk or structural damage can occur.

Tip: Mark hose bib interior shutoffs before freeze-risk nights in Bloomington, IL.
