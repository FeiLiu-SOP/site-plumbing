...
Polybutylene manifold tags in Charleston, SC basements should be photographed before any wall chase opens.

Risk flag: Temporary clamps on copper pinholes fail when chemistry remains unaddressed.

Book sump and supply-line checks in one written scope. Serving ZIP Code: 29414.

Material note: No-hub cast iron couplings require torque verification after settlement events.

Hydro-jetting in Charleston, SC requires camera confirmation before nozzle pressure is raised.
...
Basement floor drains in Charleston, SC should be snaked only after trap arm geometry is confirmed on camera.

Technicians log static and dynamic pressure before opening any wall access panel.

Permit note: Main water line replacement in Charleston, SC may require ROW restoration planning.

FAQ: Can partial repiping solve pinholes? Clustered failures often justify staged replacement.

FAQ: How fast can water lines be isolated? Missing curb-stop clearance and finished-surface access are common delays in Charleston, SC.

Drain map 710077: camera-pass priority and expansion-tank pre-charge noted for Charleston, SC postal sector 29414.

On-site sector marker: Charleston County / ZIP 29403 sector — logged for map parity and ZIP-corridor verification.
