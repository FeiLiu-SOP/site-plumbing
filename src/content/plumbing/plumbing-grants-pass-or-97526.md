...
Step: map sump float travel and check-valve orientation for Grants Pass, OR basements.

Brass ball valves should be exercised quarterly in hard-water districts.

Material note: Dielectric unions must separate copper from steel in mixed-metal runs.

Permit note: Main water line replacement in Grants Pass, OR may require ROW restoration planning.

Technicians stage dielectric kits before any copper-to-steel transition is approved.

Hard water in Grants Pass, OR accelerates scale on PRV seats and heater elements.
...
Cleanout access limits in Grants Pass, OR frequently extend drain cleaning duration.
