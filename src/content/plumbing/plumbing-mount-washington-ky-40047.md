...
Risk flag: Seasonal Mount Washington, KY irrigation cross-connections can mask domestic pressure loss.

Stack vent offsets in Mount Washington, KY older duplexes can mask tub gurgle as a main-line failure.

Step: verify expansion tank pre-charge when heaters are replaced.

Brass ball valves should be exercised quarterly in hard-water districts.

Trenchless sleeve pulls near Mount Washington, KY require pit shoring notes when water tables are high.

Tip: Keep prior snaking receipts to show recurring blockage locations.

Recirculation pump failures in Mount Washington, KY can mimic fixture-specific clogs.

Material note: Water heater anode type may change with Mount Washington, KY hardness profiles.
...
Lineage note 747324: recirculation pump amp draw captured before Mount Washington, KY branch isolation.

Coordinate-anchored dispatch note: center reference 38.0400, -85.5600 at elevation ~666 ft aligns with Bullitt County intake staging.
