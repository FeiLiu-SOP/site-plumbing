...
Sewer gas odors in Thomasville, NC should trigger trap seal and vent path review.

Permit note: Main water line replacement in Thomasville, NC may require ROW restoration planning.

Step: separate fixture repairs from branch-line cleaning in written scope.

Step: map sump float travel and check-valve orientation for Thomasville, NC basements.

Trenchless sleeve pulls near Thomasville, NC require pit shoring notes when water tables are high.

Polybutylene manifold tags in Thomasville, NC basements should be photographed before any wall chase opens.

Code note: T&P discharge must not terminate where scalding risk or structural damage can occur.

Material note: Water heater anode type may change with Thomasville, NC hardness profiles.

Risk flag: Temporary clamps on copper pinholes fail when chemistry remains unaddressed.

Risk flag: Seasonal Thomasville, NC irrigation cross-connections can mask domestic pressure loss.
